...
<div class="col-md-12">
{{--	<form action="{{ route('subscription.stripe.checkout', ['package_id' => $package->id]) }}" method="POST">--}}
		<form action="{{action([\Modules\Superadmin\Http\Controllers\SubscriptionController::class, 'stripeCheckout'], [$package->id])}}" method="POST">
		@csrf
