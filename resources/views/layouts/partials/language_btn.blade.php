<details class="tw-dw-dropdown tw-dw-dropdown-end"
    ...
    <summary class="tw-bg-transparent tw-text-black tw-font-medium tw-text-sm md:tw-text-base select-none"
             style="display: inline-flex; align-items: center; padding-top: 2px;">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"
             style="width: 1.5em; height: 1.5em; fill: currentColor; padding-top:3px">
        ...
        {{ config('constants.langs')[app()->getLocale()]['full_name'] ?? config('constants.langs')[config('app.locale')]['full_name'] }}
    </summary>
    <ul
